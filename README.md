...
There is a good chance that your search terms will also identify terms that are completely irrelevant to your clinical event of interest. Therefore you can optionally perform another search using *exclusion* search terms. Before removing any terms highlighted for exclusion, it is important to make sure any desired terms haven't been erroneously highlighted. If the list of found terms is short, you can skip straight to step 4.
...
It is possible that you may want to categorise the codes you are searching for, for example, if you are searching for codes related to smoking status, you may want to further classify the codes to identify current smoking, ex smoking, or never smoking. If you repeat further searches for each of your desired categories, you can further automate the production of your codelist.
