...
There is a good chance that your search terms will also identify terms that are completely irrelevant to your clinical event of interest. Therefore you can optionally perform another search using *exclusion* search terms. Before removing any terms highlighted for exclusion, it is important to make sure any desired terms haven't been erroneously highlighted. If the list you found is short, you can skip straight to step 4.
